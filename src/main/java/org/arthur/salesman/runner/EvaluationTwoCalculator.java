 ...
 */
public class EvaluationTwoCalculator {

    private String testRatingsPath;
    private String predictionsPath;
    private String targetPath;

    private EvaluationTwoCalculator(String testRatingsPath, String predictionsPath, String targetPath) {
    ...
    public static EvaluationTwoCalculator getCalculator(final Properties props) throws IOException {
        ...
        if (StringUtils.isNoneBlank(testRatingsPath, predictionsPath, targetPath)) {
            ...
            return new EvaluationTwoCalculator(testRatingsPath, predictionsPath, targetPath);
        } else {
